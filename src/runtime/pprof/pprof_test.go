...
// blockFrequentShort produces 1000 block events with a total duration of
// 100*rate ns.
...
// blockFrequentShort produces 100 block events with a total duration of
// 100*rate ns.
