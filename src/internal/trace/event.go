...
// TODO: Add an Event.Config() method to faciliate the manipulation of existing
// events? This would probably be most useful once a Writer has been
// implemented.
...
func MakeEvent[T EventDetails](c EventConfig[T]) (e Event, err error) {
	// TODO: make the evTable reusable? maybe via an opague Table struct,
	// NewTable and EvenConfig.Table field?
	e = Event{
...
func makeLabelEvent(e Event, l Label) (Event, error) {
	...
	// TODO: check against sched ctx and return error on mismatch
...
func makeStateTransitionEvent(e Event, t StateTransition) (Event, error) {
	...
	case ResourceProc:
		...
		case from == ProcIdle && to == ProcIdle:
			// TODO: Could this also be a ProcStatus event?
...
var procState2Tracev2ProcStatus = [...]tracev2.ProcStatus{
	...
	// TODO: how to map ProcSyscall and ProcSyscallAbandoned?
}
